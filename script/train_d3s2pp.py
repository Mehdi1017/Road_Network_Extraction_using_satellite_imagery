...
class DeepLabV3PlusD3S2PP(SegmentationModel):
    def __init__(self, encoder_name="resnet50", encoder_weights="imagenet", classes=1):
        ...
        # Define the decoder layers explicitly in __init__
        # This matches the state_dict keys from your saved model
        
        # Project low-level features (usually 256 channels for ResNet stage 2)
        ...
        # Final Convs after fusion
        self.final_convs = nn.Sequential(
            nn.Conv2d(304, 256, 3, padding=1, bias=False), # 256 (high) + 48 (low) = 304
            nn.BatchNorm2d(256),
            nn.ReLU(),
