...
MODEL_PATH = "./unet_resnet50_best_fine_tunned_parameters.pth" 
TEST_LIST = "../src/test_list.txt"

# Output folders
OUTPUT_DIR = "../results/test_results_resnet50_de_parameters" # Changed folder name to avoid overwriting
